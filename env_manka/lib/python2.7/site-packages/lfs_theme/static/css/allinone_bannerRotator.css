...
.allinone_bannerRotator.attractive .leftNav {
	...
	width:53px;
	height:127px;
	background:url('../img/elegant/leftNavOFF.png') 0 0 no-repeat;
	cursor: pointer;
}
.allinone_bannerRotator.attractive .leftNav:hover {
	background:url('../img/elegant/leftNavON.png') 0 0 no-repeat;
}
.allinone_bannerRotator.attractive .rightNav {
	...
	width:53px;
	height:127px;
	background:url('../img/elegant/rightNavOFF.png') 0 0 no-repeat;
	cursor: pointer;
}
.allinone_bannerRotator.attractive .rightNav:hover {
	background:url('../img/elegant/rightNavON.png') 0 0 no-repeat;
}
...
.allinone_bannerRotator.attractive .bottomNavButtonOFF {
	...
	width:11px;
	height:11px;
	background:url('../img/elegant/bottomNavOFF.png') 0 0 no-repeat;
	padding-left:9px;
	cursor: pointer;
}
...
.allinone_bannerRotator.attractive .bottomNavButtonON {
	...
	height:11px;
	padding-left:9px;
	background:url('../img/elegant/bottomNavON.png') 0 0 no-repeat;
	cursor: pointer;
}
...
.allinone_bannerRotator.attractive .bottomNavLeft {
	...
	height:35px;
	margin-left:1px;
	background:url('../img/elegant/bottomNavLeft.png') 0 0 no-repeat;
	z-index:4;
}
.allinone_bannerRotator.attractive .bottomNavRight {
	...
	height:35px;
	margin-left:-1px;
	background:url('../img/elegant/bottomNavRight.png') 0 0 no-repeat;
	z-index:4;
}
...
.allinone_bannerRotator.attractive .bottomOverThumb {
	...
	width:88px;
	height:106px;
	background:url('../img/elegant/bottomOverThumbBg.png') 23px bottom no-repeat;
	bottom:27px;
	margin-left:-25px;
}
...
.allinone_bannerRotator.classic .bottomNav {
	position:absolute;
	background:url('../img/elegant/bottomNavBg.png') 0 0 repeat-x;
	width:0px;
	height:24px;
	z-index:4;
	padding-left:9px;
...
.textElement52_classic {
	width:43%;
	background:url(img/elegant/textBg_transparency.png);
